...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	private static final String AUTHORITIES_BY_USERNAME =
			"select "
			+ "gebruikers.naam as username, "
			+ "rollen.naam as authorities" +
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.formLogin().loginPage("/login").and().logout().logoutSuccessUrl("/?logout").and().authorizeRequests() //JSP PAGINA login
